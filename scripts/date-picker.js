...
(function (TheDatepicker) {
  ...
  var Options = (function () {
    function Options(translator, classNames) {
      ...
      this.dayModifiers_ = [];
      this.inputFormat_ = 'd.m.Y';    //Здесь задаем формат даты
...
(function (TheDatepicker) {
  ...
  var Translator = (function () {
    function Translator() {
      ...
      this.titles_ = [
        'К следующему месяцу', //'Go to previous month',
        'К предыдущему месяцу', //'Go to next month',
        'Закрыть календарь',//'Close calendar',
        'Сбросить календарь',//'Reset calendar',
        'Отменить выбор даты',//'Deselect date',
        'Выбор месяца',//'Month selection',
        'Выбор года',//'Year selection',
        'Показать предыдущий год',//'Show earlier years',
        'Показать следующий год',//'Show later years',
      ];
    }
